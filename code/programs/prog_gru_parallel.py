...
import random
import datetime
from public.GRU_Parallel import PGruParallelRes
...
PATH_t53 = os.path.join(WHOLE, 'taobao_53_choose_5000users_30buys/')
PATH = PATH_t5
...
class Params(object):
    ...
    def build_model_mini_batch(self, flag):
        ...
        model = PGruParallelRes(
            ...
            alpha_lambda=[p['alpha'], p['lambda'], p['fea_random_zero']],
